...
public class pgrk4441 {
    ...
    pgrk4441() {} //default constructor

    pgrk4441(int iter, int initval, String filename)     // 3 argument constructor to initialize class variables with provided command line arguments
    {
        this.iter = iter;
    ...
    {
        if(args.length != 3) {
            System.out.println("Usage: pgrk4441 iterations initialvalue filename");
            return;
        }
        ...
        pgrk4441 pr = new pgrk4441(iterations, initialvalue, filename);

        pr.pgrkAlgo4441();
    }

    boolean isConverged4441(double[] src, double[] target)
    {
        for(int i = 0; i < n; i++)
        {
    ...
    void pgrkAlgo4441() {
        ...
        if(n > 10) {
          ...
          do {
               ...
               i++;
             } while (isConverged4441(Src, D) != true);
